...
#=================================== Working ================================================
def exit():
  exit=tkinter.messagebox.askyesno("Employee system","Do you want to exit the programme")
  if exit>0:
    root.destroy()
    return
...
lblNINumber=Label(fla,text="ID Number",font=('arial',16,'bold'),bd=20,fg="red",bg="powder blue").grid(row=1,column=2)
